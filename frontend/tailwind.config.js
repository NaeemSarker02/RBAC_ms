  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-mesh': 'radial-gradient(at 40% 20%, hsla(210,100%,70%,0.5) 0px, transparent 50%), radial-gradient(at 80% 0%, hsla(180,100%,70%,0.33) 0px, transparent 50%), radial-gradient(at 0% 50%, hsla(240,100%,70%,0.33) 0px, transparent 50%)',
      },
      animation: {
